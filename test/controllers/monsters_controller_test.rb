...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { : @monster., : @monster., : @monster., : @monster., : @monster., attack: @monster.attack, defence: @monster.defence, health: @monster.health, level: @monster.level, name: @monster.name } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { : @monster., : @monster., : @monster., : @monster., : @monster., attack: @monster.attack, defence: @monster.defence, health: @monster.health, level: @monster.level, name: @monster.name } }
